...
--   05. PROJECTS            sample client work (RSI-2026-00001 â€¦)
...
--               Â· websites / e-commerce  up to 10,000,000
--               Â· systems / software     up to 20,000,000
-- ============================================================
...
('company_x',               ''),
('company_linkedin',        ''),
('company_about',           'Reagan Soft Innovation Limited is a software company based in Jinja, Uganda. We design and build websites, business systems, e-commerce stores and custom software for businesses across the country â€” and we stay around to look after them after launch.'),
('currency',                'UGX'),
('tax_percent',             '0'),
...
-- 05 Â· PROJECTS
-- ============================================================
-- user ids:  1 admin Â· 2 staff Â· 3 Kireka Â· 4 Pearl Â· 5 Mulumba Â· 6 Nakato
-- ============================================================
...
('RSI-2026-00001', 3, 1, 1, 'Company Website â€“ Kireka Farm Supplies Ltd',
...
('RSI-2026-00002', 4, 3, 2, 'Sales & Stock Management System â€“ Pearl Holdings Ltd',
...
('RSI-2026-00003', 5, 2, 2, 'E-Commerce Store â€“ Mulumba & Sons Traders',
...
('RSI-2026-00004', 6, 3, NULL, 'Customer Feedback Portal â€“ Agnes Nakato',
...
('RSI-2026-00005', 3, 6, 1, 'Brand Refresh & Business Cards â€“ Kireka Farm Supplies Ltd',
